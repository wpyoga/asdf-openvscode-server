...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for openvscode-server.
...
download_release() {
  ...
  # TODO: Adapt the release URL convention for openvscode-server
...
install_version() {
  ...
  (
    ...
    # TODO: Asert openvscode-server executable exists.
    local tool_cmd
